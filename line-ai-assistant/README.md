...
- **聊天問答** — 傳什麼問題都可以問
- **對話記憶** — 記得最近 20 則訊息、保留 24 小時（需綁定 KV，見下方說明）
- **即時天氣** — 問「今天天氣如何」「台北會下雨嗎」「要帶雨傘嗎」會去查真實天氣資料再回答，涵蓋全台 19 個縣市，沒指定地點時預設查彰化
...
| `LOCATIONS` | 天氣查詢支援的縣市，第一筆是沒指定地點時的預設值 |
| `WEATHER_KEYWORDS` | 哪些字會觸發查天氣 |
